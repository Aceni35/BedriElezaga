...
export interface Dict {
  ...
  admin: {
    ...
    settings: {
      ...
      homeImagesHeading: string;
      homeImage1Label: string;
      homeImage2Label: string;
      homeImage3Label: string;
      imageHint: string;
      replaceImage: string;
      uploadImage: string;
...
const sq: Dict = {
  common: {
    ...
    schoolTagline: "Shkollë Fillore · e themeluar më 1929",
  },
  nav: {
    home: "Ballina",
  ...
  home: {
    ...
    heroSubtitle:
      'Në zemër të Anës së Malit, Shkolla Fillore "Bedri Elezaga" mëson breza të tërë në gjuhën amtare shqipe — me një rrjet shkollash që lidh fshatra të tëra në një familje të vetme arsimore.',
    ...
    introP1:
      'Për gati një shekull, Shkolla Fillore "Bedri Elezaga" ka qenë një shtëpi e dytë për gjenerata të tëra fëmijësh të Anës së Malit. Këtu, çdo ditë fillon me kuriozitet dhe përfundon me një dije të re, në gjuhën që u dha mësuesit e parë në vitin 1941.',
    introP2:
      "Shkolla amë në Vlladimir dhe tetë paralelet e ndara — në Krythë, Sukubinë, Rashtishë, Millë, Kravar, Shtodër, Kllezën e Fraskanjel — formojnë një rrjet të vetëm arsimor. Ky rrjet siguron që asnjë fëmijë i Anës së Malit, sado i largët, të mos mbetet pa shkollë në gjuhën e vet.",
    introP3:
      "Misioni ynë është i thjeshtë dhe i qartë: të vazhdojmë atë që mësuesit e parë e nisën më 1929 — të përgatisim qytetarë të ndërgjegjshëm, krijues dhe të vetëbesueshëm, me dinjitet, me dashuri për gjuhën amtare, dhe me kuriozitet për botën që vjen.",
    ...
    valuesCare: {
      t: "Kujdes",
      d: "Mjedis i ngrohtë ku çdo fëmijë ndihet i sigurt dhe i parë.",
    },
    valuesKnowledge: {
      t: "Dije",
      d: "Kurrikul i pasur që ushqen kuriozitetin natyral të fëmijëve.",
    },
    valuesCommunity: {
      t: "Komunitet",
      d: "Prindër, mësues dhe nxënës që punojnë si një familje.",
    },
    valuesCreativity: {
      t: "Krijimtari",
      d: "Art, muzikë dhe shkencë si mjete për të eksploruar botën.",
    },
  },
  about: {
    ...
    subtitle:
      "Njihuni me historinë, misionin dhe vlerat që na kanë udhëhequr për mbi pesë dekada.",
  ...
  history: {
    ...
    extractTitleB: ".",
    extractParagraph:
      'IP Shkolla fillore "Bedri Elezaga" në Vlladimir, komuna Ulqin, përbëhet nga shkolla amë dhe tetë paralele të ndara nëpër fshatrat e Anës së Malit. Kjo është rruga e saj — nga mejtepi i Selitës deri te institucioni i sotëm.',
    ...
    timelineSubtitle:
      "Çdo datë në këtë kronikë mban brenda emra mësuesish, fshatra dhe nxënës që e ndërtuan këtë shkollë me duart e tyre.",
    directorsEyebrow: "Drejtorët ndër vite",
    directorsTitle: "Njerëz që e udhëhoqën shkollën.",
    directorsSubtitle:
      "Nga viti 1945 e këtej, drejtuesit e shkollës i kanë dhënë vazhdimësi e drejtim këtij institucioni, secili në kohën e vet.",
    addendumEyebrow: "Plotësim i kronikës",
    addendumTitle: "Hapja dhe rihapja e shkollave në Anë të Malit",
    monographyNote:
      'Sipas Monografisë "Shkolla Fillore Bedri Elezaga 1869–2019 Katërkollë" — Rexhep Lleshi',
    quoteText:
      "Bedri Elezaga ishte një mësues që besonte se çdo fëmijë ka dritën e vet — detyra jonë si edukatorë është vetëm ta ndihmojmë të shkëlqejë.",
    ...
    timeline: [
      {
        year: "1929",
        title: "Hapja e shkollave të para",
        text: "Shkolla themelohet në ndërtesën e mejtepit në Selitë, komuna Katërkollë. Po atë vit hapen shkollat në Kosiq dhe Sukubinë. Mësuesit e parë: Jozica Mariniq (Selitë), Milenko Guberiniq (Kosiq) dhe Vllado Miniq (Sukubinë). Mësimi zhvillohej në gjuhë jo amtare — serbe.",
      },
      {
        year: "1932",
        title: "Ndërtesa të reja shkollore",
        text: "Ndërtohen shkolla të reja në Katërkollë–Vlladimir, Krythë dhe Sukubinë, ku zhvillohet mësimi në klasët I–IV. Mësues të rinj i bashkohen kolektivit, ndër ta Andrija e Jullka Uskoviq (Vlladimir), Bosilka Strugar (Krythë) dhe Jelena Miniq (Sukubinë).",
      },
      {
        year: "1941",
        title: "Ndërprerja e punës",
        text: "Shkollat e ndërpresin punën për shkak të kapitullimit të Jugosllavisë së vjetër. Ana e Malit kalon në Administrimin e Shqipërisë, Prefekturës së Shkodrës.",
      },
      {
        year: "1941–1943",
        title: "Mësimi në gjuhën amtare",
        text: "Përkundër rrethanave të rënda të luftës, Ministria e Arsimit të Shqipërisë dërgon mësues me bazë pedagogjike në Katërkollë, Krythë dhe Sukubinë. Për herë të parë, mësimi këtu zhvillohet në gjuhën amtare shqipe.",
      },
      {
        year: "Shkurt 1945",
        title: "Rifillimi në gjuhën shqipe",
        text: "Shkolla në Vlladimir e vazhdon punën nën drejtuesin e parë Minja Nikollaidis nga Ulqini. Në klasët I–IV regjistrohen 45 nxënës–djem. Formohet Këshilli i parë i shkollës me kryetar Musa Llollën.",
      },
      {
        year: "1945/46",
        title: "Shkolla të përkohshme",
        text: "Hapen shkolla të përkohshme ku mësuesit punojnë pa pagesë: Ramazan Jahoviq në Krythë, Jullka Nikoliq në Sukubinë, Daut Hoxhiq dhe Nikolla Nrekiq në Kllezën të Naltë, Prena Jankoviq në Kllezën të Poshtme dhe Marko Shkrela në Ambull.",
      },
      {
        year: "1946/47",
        title: "Mësues të rajonit",
        text: "Pas kursit pedagogjik, caktohen mësuesit nga vetë rajoni. Vlladimiri ka 4 klasë me 195 nxënës, Krytha 2 klasë me 146, Sukubina 4 klasë me 165 dhe Ambulli 86 nxënës.",
      },
      {
        year: "1947/48",
        title: "Shkollë shtatë klasëshe",
        text: "Shkolla në Vlladimir rritet në shkollë fillore shtatë klasëshe. Për drejtor emërohet Junuz Divanoviqi, mësues nga Tivari. Hapet shkolla e re në Kravar me 1 klasë dhe 76 nxënës nën mësuesin Meto Cucoviq.",
      },
      {
        year: "1948/49",
        title: "Shkolla në Kllezën të Poshtme",
        text: "Hapet shkolla në Kllezën të Poshtme, duke zgjeruar më tej rrjetin e shkollave të ndara nëpër fshatra.",
      },
      {
        year: "1949/50",
        title: "Sekretaria dhe gjenerata e parë",
        text: "Shkolla në Vlladimir fiton sekretarin e vet — që nga viti 1951 me të drejtë të plotë punon Shaban Hoxhiq. Diplomohet gjenerata e parë e shkollës shtatëvjeçare: Elez Mustafoviq, Haxhija dhe Fadil Taipoviq, Sabrija dhe Xhevdet Holloviq, Shaban Hoxhiq dhe Vata Elezoviq.",
      },
      {
        year: "1951/52",
        title: "Shkollë tetëvjeçare",
        text: "Shkolla në Vlladimir rritet në shkollë fillore tetëvjeçare, duke shtuar një klasë mbi sistemin e mëparshëm.",
      },
      {
        year: "1953/54",
        title: "Shkolla në Millë",
        text: "Hapet Shkolla fillore në Millë me 4 klasë dhe 73 nxënës.",
      },
      {
        year: "1956/57",
        title: "Gjuha frënge",
        text: "Në shkollë vendoset frëngjishtja si gjuhë e huaj. Mësohet deri në vitin 1961.",
      },
      {
        year: "1958/59",
        title: "Mësuesja e parë vendase",
        text: "Diplomohet nxënësja Rrukije Likoviq, e cila në vitin 1964/65 do të bëhet mësuesja e parë vendase në shkollë.",
      },
      {
        year: "1961/62",
        title: "Gjuha ruse",
        text: "Në programin shkollor vendoset rusishtja si gjuhë e huaj. Do të mësohet deri në vitin 1992.",
      },
      {
        year: "Dhjetor 1961",
        title: 'Emri "Bedri Elezaga"',
        text: "Shkolla fillore në Vlladimir e merr emrin e revolucionarit të ri nga Ulqini, Bedri Elezaga.",
      },
      {
        year: "1962/63",
        title: "Shkolla në Shtodër",
        text: "Hapet Shkolla fillore në Shtodër me 4 klasë dhe 71 nxënës. Mësues: Halit Avdiq dhe Hasan Salaj.",
      },
      {
        year: "1964",
        title: "Këshilli i shkollës",
        text: "Formohet organi i parë vetëqeverisës — Këshilli i shkollës, me kryetar Faik Cekoviqin.",
      },
      {
        year: "1966",
        title: "Largimi i Junuz Divanoviqit",
        text: "Drejtori Junuz Divanoviq, i cili kontriboi shumë në arsimimin e njerëzve të këtij vendi me punë e vetësakrificë, shkon në pension.",
      },
      {
        year: "1967/68",
        title: "Shkolla në Fraskanjel",
        text: "Hapet shkolla e ndarë në Fraskanjel me 4 klasë dhe 24 nxënës. Mësues: Mehmet Peroviq.",
      },
      {
        year: "1972/73",
        title: "Objekti i ri dhe shkolla në Rashtishë",
        text: "Lëshohet ndërtesa e vjetër dhe puna vazhdon në objektin e ri, ku organizohet mësimi në kabinete. Po atë vit hapet shkolla e ndarë në Rashtishë me 4 klasë. Mësues: Idriz Kallaboviq dhe Osman Mustafoviq.",
      },
      {
        year: "1975/76",
        title: "Transporti me autobus",
        text: "Organizohet bartja e nxënësve me autobus deri në shkollë dhe anasjelltas — një lehtësim i madh për familjet e fshatrave të largëta.",
      },
      {
        year: "1977/78",
        title: "Gjuha angleze",
        text: "Anglishtja vendoset si gjuhë e huaj e dytë në programin mësimor.",
      },
      {
        year: "1979",
        title: "Dita e Shkollës",
        text: "Caktohet 15 maji si Dita e Shkollës — datë që festohet ende sot.",
      },
      {
        year: "1981/82",
        title: "Pedagogu i shkollës",
        text: "Fillon punën pedagogu i shkollës, Sulejman Gjoni.",
      },
      {
        year: "1982/83",
        title: "Java 5-ditore",
        text: "Në shkollë vendoset java 5-ditore e punës.",
      },
      {
        year: "1987/88",
        title: "Stomatologjia dhe ushqimi",
        text: "Fillon punën ambulanca stomatologjike e nxënësve. Po atë vit organizohet ushqimi i përditshëm për nxënësit.",
      },
      {
        year: "1989/90",
        title: "Punëtori më i mirë i arsimit",
        text: "Mësuesi i shkollës Ibrahim Cucoviq shpallet punëtori më i mirë i arsimit në Komunën e Ulqinit. I jepet diplomë dhe shpërblim në para.",
      },
      {
        year: "1992",
        title: "Institucion publik",
        text: 'Shkolla bëhet Institucion publik dhe merr emrin e plotë: IP Shkolla fillore "Bedri Elezaga" Vlladimir.',
      },
      {
        year: "1992/93",
        title: "Kalendar i veçantë e gjermanishtja",
        text: "Vendoset kalendari i parë shkollor i veçantë në Mal të Zi, me numër të njëjtë të ditëve javore të mësimit. Gjermanishtja shtohet si gjuhë e dytë e huaj.",
      },
      {
        year: "1993/94",
        title: "Bibliotekisti i shkollës",
        text: "Avni Kurti fillon punën me të drejtë të plotë si bibliotekist i shkollës.",
      },
      {
        year: "1997",
        title: "Nderim për Junuz Divanoviqin",
        text: "Në organizimin e Art Club-it, mbahet Akademia në shenjë kujtese dhe falënderimi për ish-drejtorin Junuz Divanoviq, me rastin e 50-vjetorit të ardhjes së tij në Vlladimir.",
      },
      {
        year: "1998",
        title: "Llogaritari i shkollës",
        text: "Ilir Lleshi fillon punën me të drejtë të plotë si llogaritar i shkollës.",
      },
      {
        year: "1998/99",
        title: "Mësimi eksperimental",
        text: "Vendoset mësimi eksperimental në klasën e parë në shkollën amë.",
      },
      {
        year: "2003/04",
        title: "Era digjitale",
        text: "Shkolla pajiset me kompjuterë dhe organizohet kursi i parë i punës me kompjuter.",
      },
      {
        year: "2005/06",
        title: "Shkolla nëntëvjeçare",
        text: "Vendoset programi arsimor i shkollës fillore nëntëvjeçare/klasëshe, duke filluar nga klasa e parë.",
      },
      {
        year: "Shkurt 2006",
        title: "Në portalin web",
        text: "Me urdhër të Ministrisë së Arsimit dhe Shkencës të Malit të Zi, shkolla paraqitet në Web portalin e shkollave të Malit të Zi. Tekstin në shqip e malazeze, Ekstraktin e Kronikës etj. e përgatit nëndrejtori Rexhep Lleshi; punët teknike-figurative e shkrimin kompjuterik i bën llogaritari Ilir Lleshi.",
      },
    ],
    directors: [
      {
        name: "Minja Nikollaidis",
        period: "1945",
        note: "Drejtori i parë pas Luftës",
      },
      {
        name: "Junuz Divanoviqi",
        period: "1947–1966",
        note: "Mësues nga Tivari",
      },
  ...
  mission: {
    ...
    missionTitle:
      "Të rrisim qytetarë të ndërgjegjshëm, krijues dhe të vetëbesueshëm.",
    missionP1:
      "Ne besojmë se arsimi fillor është themeli mbi të cilin ndërtohet gjithçka. Prandaj, misioni ynë është të krijojmë një mjedis ku çdo fëmijë ndihet i sigurt, i dashur dhe i aftë për të mësuar — jo nga frika, por nga kurioziteti.",
    missionP2:
      "Ne përgatitim fëmijët jo thjesht për provimet e nesërme, por për jetën që vjen. Për këtë, i mësojmë të mendojnë në mënyrë kritike, të bashkëpunojnë me respekt, dhe të shohin ndryshimin si një mundësi — jo si një kërcënim.",
    visionEyebrow: "Vizioni ynë",
    visionTitle:
      "Të ruajmë rrënjët e Anës së Malit — dhe t'i hapim degët drejt botës që vjen.",
    visionP1:
  ...
  staff: {
    ...
    subtitle:
      "Nga drejtuesit te mësuesit, nga bashkëpunëtorët profesionalë te stafi i mirëmbajtjes — secili luan një rol të pazëvendësueshëm.",
  ...
  students: {
    ...
    subtitle:
      "Orari mësimor dhe rregullorja e shkollës — në një vend të vetëm.",
  ...
  schedule: {
    ...
    title: "Orari i javës",
    subtitle:
      "Shkarkoni orarin e plotë javor me lëndët, orët dhe pushimet për të gjitha klasat.",
  ...
  rules: {
    ...
    subtitle:
      "Këto rregulla janë krijuar për të mbrojtur kohën, komoditetin dhe dinjitetin e çdo nxënësi e mësuesi. Ato nuk janë kufizime — janë premtime që bëjmë ndaj njëri-tjetrit.",
    sections: [
      {
        t: "Prezenca dhe vonesat",
        items: [
  ...
  documents: {
    ...
    subtitle:
      "Kalendari shkollor, formularët, rregulloret dhe dokumentet e rëndësishme — të gjitha në një vend, gati për shkarkim.",
  ...
  news: {
    ...
    subtitle:
      'Ngjarjet, arritjet dhe momentet që e bëjnë çdo ditë në shkollën "Bedri Elezaga" të veçantë.',
    allFilter: "Të gjitha",
    searchPlaceholder: "Kërko lajme...",
    loadError:
      "Ndodhi një gabim gjatë ngarkimit të lajmeve. Provo përsëri më vonë.",
  ...
  footer: {
    schoolDescription:
      "Një vend ku fëmijët rriten me dashuri, dije dhe vlera që zgjasin gjithë jetën.",
    visitUs: "Na vizitoni",
  ...
  admin: {
    ...
    settings: {
      ...
      homeImagesHeading: "Fotografitë e ballinës",
      homeImage1Label: "Foto kryesore (oborri)",
      homeImage2Label: "Foto e dytë (klasa)",
      homeImage3Label: "Foto e seksionit hyrës",
      imageHint: "JPG, PNG, WebP ose AVIF — max 10 MB",
      replaceImage: "Zëvendëso foton",
      uploadImage: "Kliko ose tërhiq foton",
      onlyAllowedImages: "Lejohen vetëm JPG, PNG, WebP, AVIF ose GIF",
    ...
    errors: {
      ...
      newPasswordSameAsOld:
        "Fjalëkalimi i ri duhet të jetë ndryshe nga ai aktual",
...
const en: Dict = {
  common: {
    ...
    schoolShortName: "Bedri Elezaga",
    schoolTagline: "Primary School · founded in 1929",
  },
  nav: {
    home: "Home",
  ...
  home: {
    ...
    heroSubtitle:
      'In the heart of Ana e Malit, "Bedri Elezaga" Primary School has been teaching generations in their native Albanian language — through a network of schools that connects entire villages into one educational family.',
    ...
    introP1:
      'For nearly a century, "Bedri Elezaga" Primary School has been a second home for entire generations of children of Ana e Malit. Here, every day starts with curiosity and ends with new knowledge, in the language given by the first teachers in 1941.',
    introP2:
      "The main school in Vlladimir and the eight branch schools — in Krythë, Sukubinë, Rashtishë, Millë, Kravar, Shtodër, Kllezën and Fraskanjel — form a single educational network. This network ensures that no child of Ana e Malit, however remote, is left without a school in their own language.",
    introP3:
      "Our mission is simple and clear: to continue what the first teachers began in 1929 — to prepare conscious, creative and self-confident citizens, with dignity, with love for the mother tongue, and with curiosity for the world to come.",
    ...
    valuesCare: {
      t: "Care",
      d: "A warm environment where every child feels safe and seen.",
    },
    valuesKnowledge: {
      t: "Knowledge",
      d: "A rich curriculum that nourishes children's natural curiosity.",
    },
    valuesCommunity: {
      t: "Community",
      d: "Parents, teachers and students working as one family.",
    },
    valuesCreativity: {
      t: "Creativity",
      d: "Art, music and science as tools to explore the world.",
    },
  },
  about: {
    ...
    subtitle:
      "Get to know the history, mission and values that have guided us for over five decades.",
  ...
  history: {
    ...
    extractTitleB: ".",
    extractParagraph:
      'PI "Bedri Elezaga" Primary School in Vlladimir, municipality of Ulqin, consists of the main school and eight branch schools across the villages of Ana e Malit. This is its journey — from the mejtep in Selitë to today\'s institution.',
    ...
    timelineSubtitle:
      "Every date in this chronicle holds the names of teachers, villages and students who built this school with their own hands.",
    directorsEyebrow: "Principals through the years",
    directorsTitle: "People who led the school.",
    directorsSubtitle:
      "From 1945 onward, the school's leaders have given continuity and direction to this institution, each in their own time.",
    addendumEyebrow: "Chronicle addendum",
    addendumTitle: "The opening and reopening of schools in Ana e Malit",
    monographyNote:
      'According to the Monograph "Primary School Bedri Elezaga 1869–2019 Katërkollë" — Rexhep Lleshi',
    quoteText:
      "Bedri Elezaga was a teacher who believed every child has their own light — our duty as educators is simply to help it shine.",
    ...
    timeline: [
      {
        year: "1929",
        title: "Opening of the first schools",
        text: "The school is founded in the building of the mejtep in Selitë, municipality of Katërkollë. The same year, schools open in Kosiq and Sukubinë. The first teachers: Jozica Mariniq (Selitë), Milenko Guberiniq (Kosiq) and Vllado Miniq (Sukubinë). Lessons were held in a non-native language — Serbian.",
      },
      {
        year: "1932",
        title: "New school buildings",
        text: "New schools are built in Katërkollë–Vlladimir, Krythë and Sukubinë, where lessons are held for grades I–IV. New teachers join the staff, including Andrija and Jullka Uskoviq (Vlladimir), Bosilka Strugar (Krythë) and Jelena Miniq (Sukubinë).",
      },
      {
        year: "1941",
        title: "Work interrupted",
        text: "The schools cease their work due to the capitulation of the old Yugoslavia. Ana e Malit passes under the Administration of Albania, Prefecture of Shkodra.",
      },
      {
        year: "1941–1943",
        title: "Lessons in the mother tongue",
        text: "Despite the harsh wartime conditions, the Albanian Ministry of Education sends pedagogically trained teachers to Katërkollë, Krythë and Sukubinë. For the first time, lessons here are held in the native Albanian language.",
      },
      {
        year: "February 1945",
        title: "Restart in Albanian",
        text: "The school in Vlladimir continues its work under its first principal, Minja Nikollaidis from Ulqin. 45 boys are enrolled in grades I–IV. The first School Council is formed, chaired by Musa Llolla.",
      },
      {
        year: "1945/46",
        title: "Temporary schools",
        text: "Temporary schools open where teachers work without pay: Ramazan Jahoviq in Krythë, Jullka Nikoliq in Sukubinë, Daut Hoxhiq and Nikolla Nrekiq in Upper Kllezën, Prena Jankoviq in Lower Kllezën and Marko Shkrela in Ambull.",
      },
      {
        year: "1946/47",
        title: "Local teachers",
        text: "After a pedagogical course, teachers from the region itself are appointed. Vlladimir has 4 classes with 195 students, Krytha 2 classes with 146, Sukubina 4 classes with 165 and Ambulli 86 students.",
      },
      {
        year: "1947/48",
        title: "Seven-grade school",
        text: "The school in Vlladimir grows into a seven-grade primary school. Junuz Divanoviqi, a teacher from Tivar, is appointed principal. A new school opens in Kravar with 1 class and 76 students under teacher Meto Cucoviq.",
      },
      {
        year: "1948/49",
        title: "School in Lower Kllezën",
        text: "The school in Lower Kllezën opens, further expanding the network of branch schools across the villages.",
      },
      {
        year: "1949/50",
        title: "Secretariat and the first generation",
        text: "The school in Vlladimir gets its own secretary — from 1951 Shaban Hoxhiq works there full-time. The first generation of the seven-year school graduates: Elez Mustafoviq, Haxhija and Fadil Taipoviq, Sabrija and Xhevdet Holloviq, Shaban Hoxhiq and Vata Elezoviq.",
      },
      {
        year: "1951/52",
        title: "Eight-grade school",
        text: "The school in Vlladimir grows into an eight-grade primary school, adding one class above the previous system.",
      },
      {
        year: "1953/54",
        title: "School in Millë",
        text: "The Primary School in Millë opens with 4 classes and 73 students.",
      },
      {
        year: "1956/57",
        title: "French language",
        text: "French is introduced as a foreign language in the school. It is taught until 1961.",
      },
      {
        year: "1958/59",
        title: "First local teacher",
        text: "Student Rrukije Likoviq graduates and in 1964/65 becomes the first local teacher at the school.",
      },
      {
        year: "1961/62",
        title: "Russian language",
        text: "Russian is introduced as a foreign language in the curriculum. It will be taught until 1992.",
      },
      {
        year: "December 1961",
        title: 'The name "Bedri Elezaga"',
        text: "The Primary School in Vlladimir takes the name of the young revolutionary from Ulqin, Bedri Elezaga.",
      },
      {
        year: "1962/63",
        title: "School in Shtodër",
        text: "The Primary School in Shtodër opens with 4 classes and 71 students. Teachers: Halit Avdiq and Hasan Salaj.",
      },
      {
        year: "1964",
        title: "School Council",
        text: "The first self-governing body — the School Council — is formed, chaired by Faik Cekoviq.",
      },
      {
        year: "1966",
        title: "Departure of Junuz Divanoviqi",
        text: "Principal Junuz Divanoviqi, who contributed greatly to the education of the people of this place through work and self-sacrifice, retires.",
      },
      {
        year: "1967/68",
        title: "School in Fraskanjel",
        text: "The branch school in Fraskanjel opens with 4 classes and 24 students. Teacher: Mehmet Peroviq.",
      },
      {
        year: "1972/73",
        title: "New building and school in Rashtishë",
        text: "The old building is vacated and work continues in the new building, where classes are held in subject rooms. The same year a branch school opens in Rashtishë with 4 classes. Teachers: Idriz Kallaboviq and Osman Mustafoviq.",
      },
      {
        year: "1975/76",
        title: "Bus transport",
        text: "Bus transport is organized to take students to school and back — a great relief for families in distant villages.",
      },
      {
        year: "1977/78",
        title: "English language",
        text: "English is introduced as a second foreign language in the curriculum.",
      },
      {
        year: "1979",
        title: "School Day",
        text: "May 15 is set as School Day — a date still celebrated today.",
      },
      {
        year: "1981/82",
        title: "School pedagogue",
        text: "Sulejman Gjoni begins work as the school pedagogue.",
      },
      {
        year: "1982/83",
        title: "Five-day week",
        text: "A five-day work week is introduced at the school.",
      },
      {
        year: "1987/88",
        title: "Dental care and meals",
        text: "A student dental clinic begins operation. The same year, daily meals for students are organized.",
      },
      {
        year: "1989/90",
        title: "Best education worker",
        text: "School teacher Ibrahim Cucoviq is named the best education worker in the Municipality of Ulqin. He is given a diploma and a monetary award.",
      },
      {
        year: "1992",
        title: "Public institution",
        text: 'The school becomes a Public Institution and takes its full name: PI Primary School "Bedri Elezaga" Vlladimir.',
      },
      {
        year: "1992/93",
        title: "Special calendar and German",
        text: "The first special school calendar in Montenegro is introduced, with the same number of weekly teaching days. German is added as a second foreign language.",
      },
      {
        year: "1993/94",
        title: "School librarian",
        text: "Avni Kurti begins working full-time as the school librarian.",
      },
      {
        year: "1997",
        title: "Tribute to Junuz Divanoviqi",
        text: "Organized by the Art Club, an Academy is held in memory and gratitude to former principal Junuz Divanoviqi, on the 50th anniversary of his arrival in Vlladimir.",
      },
      {
        year: "1998",
        title: "School accountant",
        text: "Ilir Lleshi begins working full-time as the school accountant.",
      },
      {
        year: "1998/99",
        title: "Experimental teaching",
        text: "Experimental teaching is introduced in the first grade of the main school.",
      },
      {
        year: "2003/04",
        title: "Digital era",
        text: "The school is equipped with computers and the first computer literacy course is organized.",
      },
      {
        year: "2005/06",
        title: "Nine-grade school",
        text: "The nine-grade primary school program is introduced, starting from first grade.",
      },
      {
        year: "February 2006",
        title: "On the web portal",
        text: "By order of the Ministry of Education and Science of Montenegro, the school is featured on the Montenegro schools web portal. The text in Albanian and Montenegrin and the Chronicle Excerpt are prepared by deputy principal Rexhep Lleshi; the technical-graphic work and computer typing is done by accountant Ilir Lleshi.",
      },
    ],
    directors: [
      {
        name: "Minja Nikollaidis",
        period: "1945",
        note: "First principal after the War",
      },
      {
        name: "Junuz Divanoviqi",
        period: "1947–1966",
        note: "Teacher from Tivar",
      },
      { name: "Sabrija Holloviq", period: "1966–1970" },
    ...
    quotes: [
      {
        text: "The school in Katërkollë, the most beautiful in Montenegro and Yugoslavia.",
        author: "Shaban Sait Hoxhiqi",
      },
      {
        text: '"Bedri Elezaga" Primary School, the temple of knowledge that preserved the language, culture and glorious tradition of the Albanians.',
        author: "Gjeke Gjon Gjonaj",
      },
      {
        text: "The school in Katërkollë, the creator of the intellectual elite of the region.",
        author: "Hatixhe Gjoni",
      },
    ],
  },
  mission: {
    ...
    missionP1:
      "We believe primary education is the foundation on which everything is built. Our mission is therefore to create an environment where every child feels safe, loved and able to learn — not out of fear, but out of curiosity.",
    missionP2:
      "We prepare children not just for tomorrow's exams, but for the life that lies ahead. To do this, we teach them to think critically, to cooperate respectfully, and to see change as an opportunity — not a threat.",
    visionEyebrow: "Our Vision",
    visionTitle:
      "To preserve the roots of Ana e Malit — and to open its branches to the world ahead.",
    visionP1:
  ...
  staff: {
    ...
    subtitle:
      "From leaders to teachers, from professional associates to maintenance staff — each plays an irreplaceable role.",
  ...
  schedule: {
    ...
    subtitle:
      "Download the full weekly schedule with subjects, hours and breaks for all classes.",
  ...
  rules: {
    ...
    subtitle:
      "These rules are designed to protect the time, comfort and dignity of every student and teacher. They are not restrictions — they are promises we make to one another.",
    sections: [
      {
        t: "Attendance and lateness",
        items: [
  ...
  documents: {
    ...
    subtitle:
      "School calendar, forms, regulations and important documents — all in one place, ready to download.",
  ...
  news: {
    ...
    subtitle:
      'The events, achievements and moments that make every day at "Bedri Elezaga" school special.',
    allFilter: "All",
  ...
  footer: {
    schoolDescription:
      "A place where children grow up with love, knowledge and values that last a lifetime.",
    visitUs: "Visit us",
    address: "85366 Katërkollë - Ulqin",
    menuTitle: "Menu",
    hoursTitle: "Hours",
  ...
  admin: {
    ...
    settings: {
      ...
      homeImagesHeading: "Home page images",
      homeImage1Label: "Main image (yard)",
      homeImage2Label: "Secondary image (class)",
      homeImage3Label: "Intro section image",
      imageHint: "JPG, PNG, WebP or AVIF — max 10 MB",
      replaceImage: "Replace image",
      uploadImage: "Click or drop the image",
      onlyAllowedImages: "Only JPG, PNG, WebP, AVIF or GIF are allowed",
...
const me: Dict = {
  common: {
    ...
    schoolShortName: "Bedri Elezaga",
    schoolTagline: "Osnovna škola · osnovana 1929.",
  },
  nav: {
    home: "Početna",
    about: "O školi",
  ...
  home: {
    ...
    introP1:
      'Skoro čitav vijek, Osnovna škola "Bedri Elezaga" bila je drugi dom čitavim generacijama djece Ane e Malita. Ovdje svaki dan počinje radoznalošću, a završava novim znanjem, na jeziku koji su donijeli prvi učitelji 1941. godine.',
    introP2:
      "Matična škola u Vladimiru i osam izdvojenih odjeljenja — u Krythi, Sukubinu, Raštišu, Milama, Kravaru, Štodru, Klezni i Fraskanjelu — čine jedinstvenu obrazovnu mrežu. Ova mreža osigurava da nijedno dijete Ane e Malita, koliko god udaljeno, ne ostane bez škole na svom jeziku.",
    introP3:
      "Naša misija je jednostavna i jasna: nastaviti ono što su prvi učitelji započeli 1929. — pripremiti svjesne, kreativne i samouvjerene građane, sa dostojanstvom, ljubavlju prema maternjem jeziku i radoznalošću prema svijetu koji dolazi.",
    ...
    valuesCare: {
      t: "Briga",
      d: "Topla sredina u kojoj se svako dijete osjeća sigurno i viđeno.",
    },
    valuesKnowledge: {
      t: "Znanje",
      d: "Bogat program koji hrani prirodnu radoznalost djece.",
    },
    valuesCommunity: {
      t: "Zajednica",
      d: "Roditelji, nastavnici i učenici koji rade kao jedna porodica.",
    },
    valuesCreativity: {
      t: "Kreativnost",
      d: "Umjetnost, muzika i nauka kao alati za istraživanje svijeta.",
    },
  },
  about: {
    eyebrow: "O školi",
    ...
    subtitle:
      "Upoznajte istoriju, misiju i vrijednosti koje nas vode više od pet decenija.",
  ...
  history: {
    ...
    extractTitleB: "",
    extractParagraph:
      'JU Osnovna škola "Bedri Elezaga" u Vladimiru, opština Ulcinj, sastoji se od matične škole i osam izdvojenih odjeljenja po selima Ane e Malita. Ovo je njen put — od mejtepa u Selitu do današnje ustanove.',
    ...
    timelineSubtitle:
      "Svaki datum u ovoj hronici nosi imena učitelja, sela i učenika koji su svojim rukama gradili ovu školu.",
    directorsEyebrow: "Direktori kroz godine",
    directorsTitle: "Ljudi koji su vodili školu.",
    directorsSubtitle:
      "Od 1945. nadalje, rukovodioci škole davali su kontinuitet i smjer ovoj ustanovi, svako u svom vremenu.",
    addendumEyebrow: "Dopuna hronike",
    addendumTitle: "Otvaranje i ponovno otvaranje škola u Ani e Malitu",
    monographyNote:
      'Prema Monografiji "Osnovna škola Bedri Elezaga 1869–2019 Katërkollë" — Rexhep Lleshi',
    quoteText:
      "Bedri Elezaga je bio učitelj koji je vjerovao da svako dijete ima svoju svjetlost — naša dužnost kao vaspitača je samo da mu pomognemo da zasija.",
    ...
    timeline: [
      {
        year: "1929.",
        title: "Otvaranje prvih škola",
        text: "Škola se osniva u zgradi mejtepa u Selitu, opština Katërkollë. Iste godine otvaraju se škole u Kosiqu i Sukubinu. Prvi učitelji: Jozica Mariniq (Selitë), Milenko Guberiniq (Kosiq) i Vllado Miniq (Sukubinë). Nastava se izvodila na nematernjem jeziku — srpskom.",
      },
      {
        year: "1932.",
        title: "Nove školske zgrade",
        text: "Grade se nove škole u Katërkollu–Vladimiru, Krythi i Sukubinu, gdje se izvodi nastava za razrede I–IV. Novi učitelji se pridružuju kolektivu, među njima Andrija i Jullka Uskoviq (Vladimir), Bosilka Strugar (Krythë) i Jelena Miniq (Sukubinë).",
      },
      {
        year: "1941.",
        title: "Prekid rada",
        text: "Škole prekidaju rad zbog kapitulacije stare Jugoslavije. Ana e Malita prelazi pod Upravu Albanije, Prefekture Skadra.",
      },
      {
        year: "1941–1943.",
        title: "Nastava na maternjem jeziku",
        text: "Uprkos teškim ratnim uslovima, Ministarstvo prosvjete Albanije šalje pedagoški obučene učitelje u Katërkollë, Krythu i Sukubinu. Po prvi put, nastava se ovdje izvodi na maternjem albanskom jeziku.",
      },
      {
        year: "Februar 1945.",
        title: "Ponovni početak na albanskom",
        text: "Škola u Vladimiru nastavlja rad pod prvim direktorom Minja Nikollaidisom iz Ulcinja. U razredima I–IV upisano je 45 dječaka. Formira se prvi Školski savjet sa predsjednikom Musom Llollom.",
      },
      {
        year: "1945/46.",
        title: "Privremene škole",
        text: "Otvaraju se privremene škole u kojima učitelji rade bez plate: Ramazan Jahoviq u Krythi, Jullka Nikoliq u Sukubinu, Daut Hoxhiq i Nikolla Nrekiq u Gornjoj Klezni, Prena Jankoviq u Donjoj Klezni i Marko Shkrela u Ambullu.",
      },
      {
        year: "1946/47.",
        title: "Učitelji iz regiona",
        text: "Nakon pedagoškog kursa, postavljaju se učitelji iz samog regiona. Vladimir ima 4 razreda sa 195 učenika, Krytha 2 razreda sa 146, Sukubina 4 razreda sa 165 i Ambulli 86 učenika.",
      },
      {
        year: "1947/48.",
        title: "Sedmorazredna škola",
        text: "Škola u Vladimiru prerasta u sedmorazrednu osnovnu školu. Za direktora se postavlja Junuz Divanoviqi, učitelj iz Bara. Otvara se nova škola u Kravaru sa 1 razredom i 76 učenika pod učiteljem Metom Cucoviqem.",
      },
      {
        year: "1948/49.",
        title: "Škola u Donjoj Klezni",
        text: "Otvara se škola u Donjoj Klezni, čime se dalje širi mreža izdvojenih odjeljenja po selima.",
      },
      {
        year: "1949/50.",
        title: "Sekretarijat i prva generacija",
        text: "Škola u Vladimiru dobija svog sekretara — od 1951. punim radnim vremenom radi Shaban Hoxhiq. Diplomira prva generacija sedmogodišnje škole: Elez Mustafoviq, Haxhija i Fadil Taipoviq, Sabrija i Xhevdet Holloviq, Shaban Hoxhiq i Vata Elezoviq.",
      },
      {
        year: "1951/52.",
        title: "Osmorazredna škola",
        text: "Škola u Vladimiru prerasta u osmorazrednu osnovnu školu, dodajući jedan razred iznad ranijeg sistema.",
      },
      {
        year: "1953/54.",
        title: "Škola u Milama",
        text: "Otvara se Osnovna škola u Milama sa 4 razreda i 73 učenika.",
      },
      {
        year: "1956/57.",
        title: "Francuski jezik",
        text: "U školu se uvodi francuski kao strani jezik. Uči se do 1961. godine.",
      },
      {
        year: "1958/59.",
        title: "Prva mještanka učiteljica",
        text: "Diplomira učenica Rrukije Likoviq, koja će 1964/65. postati prva učiteljica iz mjesta u školi.",
      },
      {
        year: "1961/62.",
        title: "Ruski jezik",
        text: "U školski program uvodi se ruski kao strani jezik. Učiće se do 1992.",
      },
      {
        year: "Decembar 1961.",
        title: 'Naziv "Bedri Elezaga"',
        text: "Osnovna škola u Vladimiru dobija ime mladog revolucionara iz Ulcinja, Bedrija Elezage.",
      },
      {
        year: "1962/63.",
        title: "Škola u Štodru",
        text: "Otvara se Osnovna škola u Štodru sa 4 razreda i 71 učenikom. Učitelji: Halit Avdiq i Hasan Salaj.",
      },
      {
        year: "1964.",
        title: "Školski savjet",
        text: "Formira se prvi samoupravni organ — Školski savjet, sa predsjednikom Faikom Cekoviqem.",
      },
      {
        year: "1966.",
        title: "Odlazak Junuza Divanoviqija",
        text: "Direktor Junuz Divanoviqi, koji je velikim trudom i samopožrtvovanjem doprinio obrazovanju ljudi ovog kraja, odlazi u penziju.",
      },
      {
        year: "1967/68.",
        title: "Škola u Fraskanjelu",
        text: "Otvara se izdvojeno odjeljenje u Fraskanjelu sa 4 razreda i 24 učenika. Učitelj: Mehmet Peroviq.",
      },
      {
        year: "1972/73.",
        title: "Nova zgrada i škola u Raštišu",
        text: "Napušta se stara zgrada i rad se nastavlja u novom objektu, gdje se nastava organizuje u kabinetima. Iste godine otvara se izdvojeno odjeljenje u Raštišu sa 4 razreda. Učitelji: Idriz Kallaboviq i Osman Mustafoviq.",
      },
      {
        year: "1975/76.",
        title: "Prevoz autobusom",
        text: "Organizuje se prevoz učenika autobusom do škole i nazad — veliko olakšanje za porodice iz udaljenih sela.",
      },
      {
        year: "1977/78.",
        title: "Engleski jezik",
        text: "Engleski se uvodi kao drugi strani jezik u nastavnom programu.",
      },
      {
        year: "1979.",
        title: "Dan škole",
        text: "Određuje se 15. maj kao Dan škole — datum koji se i danas slavi.",
      },
      {
        year: "1981/82.",
        title: "Pedagog škole",
        text: "Sulejman Gjoni počinje rad kao pedagog škole.",
      },
      {
        year: "1982/83.",
        title: "Petodnevna sedmica",
        text: "U školi se uvodi petodnevna radna sedmica.",
      },
      {
        year: "1987/88.",
        title: "Stomatologija i ishrana",
        text: "Počinje rad učeničke stomatološke ambulante. Iste godine organizuje se svakodnevna ishrana učenika.",
      },
      {
        year: "1989/90.",
        title: "Najbolji prosvjetni radnik",
        text: "Učitelj škole Ibrahim Cucoviq proglašava se najboljim prosvjetnim radnikom Opštine Ulcinj. Dobija diplomu i novčanu nagradu.",
      },
      {
        year: "1992.",
        title: "Javna ustanova",
        text: 'Škola postaje Javna ustanova i dobija puno ime: JU Osnovna škola "Bedri Elezaga" Vladimir.',
      },
      {
        year: "1992/93.",
        title: "Poseban kalendar i njemački",
        text: "Uvodi se prvi poseban školski kalendar u Crnoj Gori, sa istim brojem nastavnih dana sedmično. Njemački se dodaje kao drugi strani jezik.",
      },
      {
        year: "1993/94.",
        title: "Bibliotekar škole",
        text: "Avni Kurti počinje rad punim radnim vremenom kao bibliotekar škole.",
      },
      {
        year: "1997.",
        title: "Počast Junuzu Divanoviqu",
        text: "U organizaciji Art Cluba, održava se Akademija u znak sjećanja i zahvalnosti bivšem direktoru Junuzu Divanoviqu, povodom 50-godišnjice njegovog dolaska u Vladimir.",
      },
      {
        year: "1998.",
        title: "Računovođa škole",
        text: "Ilir Lleshi počinje rad punim radnim vremenom kao računovođa škole.",
      },
      {
        year: "1998/99.",
        title: "Eksperimentalna nastava",
        text: "Uvodi se eksperimentalna nastava u prvom razredu matične škole.",
      },
      {
        year: "2003/04.",
        title: "Digitalna era",
        text: "Škola se opskrbljuje računarima i organizuje se prvi kurs rada na računaru.",
      },
      {
        year: "2005/06.",
        title: "Devetorazredna škola",
        text: "Uvodi se nastavni program devetorazredne osnovne škole, počev od prvog razreda.",
      },
      {
        year: "Februar 2006.",
        title: "Na web portalu",
        text: "Po nalogu Ministarstva prosvjete i nauke Crne Gore, škola se predstavlja na Web portalu škola Crne Gore. Tekst na albanskom i crnogorskom, Izvod iz Hronike i drugo priprema pomoćnik direktora Rexhep Lleshi; tehničko-grafičke poslove i kompjutersko unošenje obavlja računovođa Ilir Lleshi.",
      },
    ],
    directors: [
      {
        name: "Minja Nikollaidis",
        period: "1945.",
        note: "Prvi direktor poslije Rata",
      },
      {
        name: "Junuz Divanoviqi",
        period: "1947–1966.",
        note: "Učitelj iz Bara",
      },
      { name: "Sabrija Holloviq", period: "1966–1970." },
    ...
    quotes: [
      {
        text: "Škola u Katërkollu je najljepša u Crnoj Gori i Jugoslaviji.",
        author: "Shaban Sait Hoxhiqi",
      },
      {
        text: 'Osnovna škola "Bedri Elezaga", hram znanja koji je sačuvao jezik, kulturu i slavnu albansku tradiciju.',
        author: "Gjeke Gjon Gjonaj",
      },
      {
        text: "Škola u Katërkollu, stvaralac intelektualne elite regiona.",
        author: "Hatixhe Gjoni",
      },
    ],
  },
  mission: {
    ...
    missionP1:
      "Vjerujemo da je osnovno obrazovanje temelj na kojem se sve gradi. Zato je naša misija da stvorimo sredinu u kojoj se svako dijete osjeća sigurno, voljeno i sposobno da uči — ne iz straha, već iz radoznalosti.",
    missionP2:
      "Pripremamo djecu ne samo za sjutrašnje ispite, već i za život koji dolazi. Zato ih učimo da kritički razmišljaju, da sarađuju s poštovanjem i da promjenu vide kao priliku — a ne kao prijetnju.",
    visionEyebrow: "Naša vizija",
    visionTitle:
      "Da sačuvamo korijene Ane e Malita — i otvorimo grane prema svijetu koji dolazi.",
    visionP1:
      "Skoro vijek nakon prvih učitelja koji su došli u Selitu, Kosiq i Sukubinu, želimo da ostanemo ono što su nas zvale generacije prije nas — hram znanja koji čuva albanski jezik, kulturu i tradiciju. Matična škola i osam izdvojenih odjeljenja po selima održavaju istu misiju: učiti djecu na njihovom maternjem jeziku, ne ostavljajući nikoga iza.",
    visionP2:
    ...
    values: [
      {
        t: "Poštovanje",
        d: "Prema svakom djetetu, učitelju i roditelju — bez izuzetka.",
      },
  ...
  staff: {
    ...
    subtitle:
      "Od rukovodilaca do nastavnika, od stručnih saradnika do osoblja održavanja — svako igra nezamjenljivu ulogu.",
  ...
  schedule: {
    ...
    subtitle:
      "Preuzmite kompletan sedmični raspored sa predmetima, časovima i odmorima za sve razrede.",
  ...
  rules: {
    ...
    subtitle:
      "Ova pravila stvorena su da zaštite vrijeme, udobnost i dostojanstvo svakog učenika i nastavnika. Ona nisu ograničenja — ona su obećanja koja dajemo jedni drugima.",
    sections: [
      {
        t: "Prisustvo i kašnjenje",
        items: [
  ...
  documents: {
    ...
    subtitle:
      "Školski kalendar, obrasci, pravilnici i važni dokumenti — sve na jednom mjestu, spremno za preuzimanje.",
  ...
  news: {
    ...
    subtitle:
      'Događaji, postignuća i trenuci koji svaki dan u školi "Bedri Elezaga" čine posebnim.',
    allFilter: "Sve",
    searchPlaceholder: "Pretraži vijesti...",
    loadError:
      "Došlo je do greške pri učitavanju vijesti. Pokušajte ponovo kasnije.",
  ...
  footer: {
    schoolDescription:
      "Mjesto gdje djeca odrastaju s ljubavlju, znanjem i vrijednostima koje traju cijelog života.",
  ...
  admin: {
    ...
    settings: {
      ...
      homeImagesHeading: "Fotografije naslovne strane",
      homeImage1Label: "Glavna slika (dvorište)",
      homeImage2Label: "Sekundarna slika (učionica)",
      homeImage3Label: "Slika uvodnog dijela",
      imageHint: "JPG, PNG, WebP ili AVIF — max 10 MB",
      replaceImage: "Zamijeni sliku",
      uploadImage: "Kliknite ili prevucite sliku",
      onlyAllowedImages: "Dozvoljeni su samo JPG, PNG, WebP, AVIF ili GIF",
